...
import MeshplayText from '../../assets/images/meshplay-light-text.svg';
    ...
    return (
      <>
        <div className='thankyou-box'>
          <h2>Thank you for your interest in Meshplay Playground early access program!</h2>
          <p>
            You are now signed up for the Meshplay Playground early access program and your position
